...
**Single source of truth for constants:** `DATA_LAYER/NOTRADE_CONSTANTS.yaml`  
...
- action taken (ENTER/PASS/HOLD/EXIT)
...
- HOLD when an open thesis remains valid and no full exit is justified
- EXIT when probability materially shifts, integrity breaks, or a clearly better opportunity appears
- size positions using SSOT thresholds and portfolio caps
