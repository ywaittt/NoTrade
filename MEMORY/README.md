...
## Chapter 7 verdict vocabulary
Use `PASS`, `ENTER`, `HOLD`, and `EXIT` as the core policy verdicts. Keep `BUY`, `SELL`, `MERGE`, `CONVERT`, and `HEDGE` at the transaction / execution layer.
